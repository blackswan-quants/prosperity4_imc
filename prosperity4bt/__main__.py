...
def cli(
    ...
    data: Annotated[Optional[Path], Option(help="Path to data directory. Must look similar in structure to https://github.com/nabayansaha/imc-prosperity-4-backtester/tree/master/prosperity4bt/resources.",
